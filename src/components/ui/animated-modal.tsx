      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "min-h-[50%] max-h-[90%] md:max-w-[40%] bg-neutral-950 md:rounded-2xl relative z-50 flex flex-col flex-1",
              className
            )}
            role="dialog"
            aria-modal="true"
...
const CloseIcon = () => {
  ...
  return (
    <button
      ...
      className="absolute top-4 right-4 group z-24 cursor-pointer"
    >
      <svg
