...
export const projects: Project[] = [
  {
    ...
    description:
      "A comprehensive backend system for parcel tracking and management, handling over 30,000 parcels monthly. The system integrates with multiple shipping carriers, provides real-time tracking updates, and includes a robust payment gateway integration.",
    shortDescription:
  ...
  },
  {
    ...
    description:
      "Personalized, modular NixOS and Home-Manager setup featuring dynamic theming, Lenovo Yoga optimizations, and a comprehensive development environment. The configuration includes custom scripts, automated system updates, and seamless environment switching.",
    shortDescription:
